({
    ...
    renderCalendar: function(component, event, helper) {
        ...
        var endDate = new Date(2021, 0, 1);  //Added for Knob Creek Calendar to block 2021 by Adithya
		var endDateMoment = moment(endDate).format("YYYY-MM-DD"); //Added for Knob Creek Calendar to block 2021 by Adithya
        console.log('End Day Moment:::',endDateMoment);
        ...
        $(document).ready(function() {
            ...
            $('#calendar').fullCalendar({
                ...
                dayClick: function(date, jsEvent, view) {
                    console.log('Today Momement:::',todayMoment);
                    ...
                    try {
                        ...
                        if(currentBrand == 'Knob Creek' && (moment(date.format())._i) >= endDateMoment){
                            helper.showToast('You cannot select 2021 dates for Knob Creek.', 'Error', 'error');
                            return;
                        }
