...
"undefined" == typeof window.dhx4 && (window.dhx4 = {
      ...
      readFromCss: function(t, e) {
        ...
        return n.parentNode.removeChild(n), n = null, i
      },
      lastId: 1,
      newId: function() {
        return this.lastId++
      ...
      _aOfs: function(t) {
        for (var e = 0, n = 0; t;) e += parseInt(t.offsetTop),
          n += parseInt(t.offsetLeft), t = t.offsetParent;
        return {
          top: e,
          left: n
        }
      ...
      _copyObj: function(t) {
        if (this._isObj(t)) {
          var e = {};
          for (var n in t) "object" == typeof t[n] && null != t[n] ? e[n] = this._copyObj(t[n]) : e[n] = t[n]
        } else
          for (var e = [], n = 0; n < t.length; n++) "object" == typeof t[n] && null != t[n] ? e[n] = this._copyObj(t[n]) : e[n] = t[n];
        return e
      },
      screenDim: function() {
        var t = navigator.userAgent.indexOf("MSIE") >= 0,
          e = {};
        return e.left = document.body.scrollLeft, e.right = e.left + (window.innerWidth || document.body.clientWidth), e.top = Math.max((t ? document.documentElement : document.getElementsByTagName("html")[0]).scrollTop, document.body.scrollTop),
          e.bottom = e.top + (t ? Math.max(document.documentElement.clientHeight || 0, document.documentElement.offsetHeight || 0) : window.innerHeight), e
      },
      selectTextRange: function(t, e, n) {
        t = "string" == typeof t ? document.getElementById(t) : t;
        var i = t.value.length;
        if (e = Math.max(Math.min(e, i), 0), n = Math.min(n, i), t.setSelectionRange) try {
    ...
    window.dhx4.isKHTML = navigator.userAgent.indexOf("Safari") >= 0 || navigator.userAgent.indexOf("Konqueror") >= 0, window.dhx4.isFF = navigator.userAgent.indexOf("Firefox") >= 0, window.dhx4.isIPad = navigator.userAgent.search(/iPad/gi) >= 0), "undefined" == typeof window.dhx4.ajax && (window.dhx4.ajax = {
    cache: !1,
    method: "get",
    parse: function(t) {
    ...
    xpath: function(t, e) {
      if (e.nodeName || (e = e.responseXML || e),
        dhx4.isIE) return e.selectNodes(t) || [];
  ...
  function() {
    ...
    function e(e) {
      if (g) {
        ...
        return dhtmlx.message.keyboard && ((13 == n || 32 == n) && t(g, !0),
          27 == n && t(g, !1)), e.preventDefault && e.preventDefault(), !(e.cancelBubble = !0)
      }
    }
    ...
    function a(t) {
      c.area || (c.area = document.createElement("DIV"),
        c.area.className = "dhtmlx_message_area", c.area.style[c.position] = "5px", document.body.appendChild(c.area)), c.hide(t.id);
    ...
    function r(t, i, a) {
      ...
      return "top" == t.position ? r.style.top = "-3px" : r.style.top = d + "px", r.style.left = o + "px", r.onkeydown = e, r.focus(), t.hidden && dhtmlx.modalbox.hide(r), r
    }
    ...
    setTransactionMode: function(t, e) {
      "object" == typeof t ? (this._tMode = t.mode || this._tMode, this._headers = this._headers || t.headers, this._payload = this._payload || t.payload) : (this._tMode = t, this._tSend = e),
    ...
    setUpdated: function(t, e, n) {
      if (!this._silent_mode) {
        ...
        a && "updated" == n && (n = a), e ? (this.set_invalid(t, !1), this.updatedRows[i] = t, this.obj.setUserData(t, this.action_param, n), this._in_progress[t] && (this._in_progress[t] = "wait")) : this.is_invalid(t) || (this.updatedRows.splice(i, 1), this.obj.setUserData(t, this.action_param, "")), e || this._clearUpdateFlag(t),
          this.markRow(t, e, n), e && this.autoUpdate && this.sendData(t)
      }
    },
    ...
    gantt = {
      ...
      dhtmlx.bind = function(t, e) {
        ...
        this._click.gantt_close = dhtmlx.bind(function(t, e, n) {
          ...
          if (this.callEvent("onGridHeaderClick", [i, t])) {
            if ("add" == i) return void this._click.gantt_add(t, this.config.root_id);
            if (this.config.sort) {
        ...
        for (var e = this.getGridColumns(), n = [], i = 0; i < e.length; i++) {
          ...
          dhtmlx.defined(o.align) && (g += "text-align:" + o.align + ";"), a = "<div class='" + d + "' style='" + g + "'>" + _ + s + "</div>",
            n.push(a)
        }
        var d = t.$index % 2 === 0 ? "" : " odd";
        if (d += t.$transparent ? " gantt_transparent" : "", d += t.$dataprocessor_class ? " " + t.$dataprocessor_class : "", this.templates.grid_row_class) {
        ...
        return u.className = "gantt_row" + d, u.style.height = this.config.row_height + "px", u.style.lineHeight = gantt.config.row_height + "px", u.setAttribute(this.config.task_attribute, t.id),
        ...
        if (t != n) {
          ...
          if (this.callEvent("onBeforeTaskMove", [t, n, e]) !== !1) {
            ...
            var d = r[e];
            d ? r = r.slice(0, e).concat([t]).concat(r.slice(e)) : r.push(t), this.setParent(a, n), this._branches[n] = r, a.$level = this.calculateTaskLevel(a), 1 * e > 0 ? i ? a.$drop_target = (this.getTaskIndex(t) > this.getTaskIndex(i) ? "next:" : "") + i : a.$drop_target = "next:" + gantt.getPrevSibling(t) : r[1 * e + 1] ? a.$drop_target = r[1 * e + 1] : a.$drop_target = n, this.callEvent("onAfterTaskMove", [t, n, e]) && this.refreshData()
          }
        }
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity),
          t.attachEvent("onBeforeDragStart", dhtmlx.bind(function(e, n) {
            ...
            var e = this._get_position(this.$grid_data),
              n = e.x,
              i = t.pos.y - 10;
            return i < e.y && (i = e.y), i > e.y + this.$grid_data.offsetHeight - this.config.row_height && (i = e.y + this.$grid_data.offsetHeight - this.config.row_height),
              e.x = n, e.y = i, e
            ...
            var a = t.config,
              s = t._getGridPos(n);
            a.marker.style.left = s.x + 10 + "px", a.marker.style.top = s.y + "px", s = t._getGridPos(n);
            var r = (s.x, s.y),
              o = document.elementFromPoint(s.x - document.body.scrollLeft + 1, r - document.body.scrollTop),
              d = this.locate(o),
              _ = this.getTask(t.config.id);
            if (this.isTaskExists(d) || (d = t.lastTaskOfLevel(gantt.config.order_branch_free ? _.$level : 0), d == t.config.id && (d = null)),
              this.isTaskExists(d)) {
              ...
              if (l.y + o.offsetHeight / 2 < r) {
                ...
                if (c) {
                  if (c.id == _.id) return;
                  h = c
                } else if (c = this._pull[this._order[g]], i(c, _) && c.id != _.id) return void this.moveTask(_.id, -1, this.getParent(c.id))
              }
              for (var g = this.getGlobalTaskIndex(h.id), u = this._pull[this._order[g - 1]], f = 1;
                (!u || u.id == h.id) && g - f >= 0;) u = this._pull[this._order[g - f]], f++;
              if (_.id == h.id) return;
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity),
          t.attachEvent("onBeforeDragStart", dhtmlx.bind(function(t, e) {
            ...
            t.config.marker.innerHTML = "", t.config.marker.className += " gantt_grid_resize_area",
              t.config.marker.style.height = this.$grid.offsetHeight + "px", t.config.marker.style.top = "0px", t.config.drag_index = i
          }, this)), t.attachEvent("onDragMove", dhtmlx.bind(function(e, n) {
            var i = t.config,
              ...
              l = 0;
            r -= s.x - 1;
            for (var h = 0; h < i.drag_index; h++) o += a[h].width, _ += a[h].width;
            return o > r && (r = o),
              this.config.keep_grid_width && r > d && (r = d), l = r - _, i.marker.style.top = s.y + "px", i.marker.style.left = s.x - 1 + _ + "px", i.marker.style.width = l + "px", i.left = r - 1, gantt.callEvent("onColumnResize", [i.drag_index, a[i.drag_index], l - 1]), !0
          }, this)), t.attachEvent("onDragEnd", dhtmlx.bind(function(e, n) {
            for (var i = this.getGridColumns(), a = 0, s = parseInt(t.config.drag_index, 10), r = i[s], o = 0; s > o; o++) a += i[o].width;
            ...
            if (gantt.callEvent("onColumnResizeEnd", [s, r, d]) !== !1 && r.width != d) {
              if (r.width = d, this.config.keep_grid_width)
                for (var o = s + 1, _ = i.length; _ > o; o++) "add" == i[o].name ? i[o].width = 1 * i[o].width || 44 : i[o].width = null;
              else {
                for (var o = s, _ = i.length; _ > o; o++) a += i[o].width;
        ...
        dhtmlx.defined(this.config.dnd_sensitivity) && (e.config.sensitivity = this.config.dnd_sensitivity), e.attachEvent("onBeforeDragStart", dhtmlx.bind(function(t, e) {
        ...
        }, this)), e.attachEvent("onAfterDragStart", dhtmlx.bind(function(t, n) {
        ...
        }, this)), e.attachEvent("onDragMove", dhtmlx.bind(function(t, n) {
          for (var i = e.config, a = this.config.columns, s = this._get_position(this.$grid), r = parseInt(i.marker.style.left, 10), o = 0, d = 0; d < a.length; d++) a[d].hide || (o += a[d].min_width ? a[d].min_width : this.config.min_grid_column_width);
          return r -= s.x - 1, o > r && (r = o), i.marker.style.top = s.y + "px", i.marker.style.left = s.x - 1 + "px", i.marker.style.width = r + "px", i.left = r - 1, gantt.callEvent("onGridResize", [this.config.grid_width, r - 1]), !0
        }, this)), e.attachEvent("onDragEnd", dhtmlx.bind(function(t, n) {
          for (var i = this.config.columns, a = 0, s = e.config.left, r = 0, o = i.length; o > r; r++) i[r].hide || (a += i[r].width);
          ...
          for (var g = _ > 0 ? 1 : -1; _ > 0 && 1 === g || 0 > _ && -1 === g;) {
            ...
            for (r = 0; d > r; r++) {
              var u = i[r].width + g;
              if ((i[r].min_width && u >= i[r].min_width || !i[r].min_width || h > i[r].width) && (_ -= g, i[r].width = u, 0 == _)) break
            }
            if (c == _) break
          }
          gantt.callEvent("onGridResizeEnd", [this.config.grid_width, s]) !== !1 && (this.config.grid_width = s, this.render())
        }, this))
      ...
      function() {
        ...
        if (gantt.config.branch_loading && gantt._load_url && gantt._need_dynamic_loading(t)) {
          ...
          var n = e.indexOf("?") >= 0 ? "&" : "?",
            i = 0;
          this._cached_scroll_pos && this._cached_scroll_pos.y && (i = Math.max(this._cached_scroll_pos.y, 0)), gantt.load(e + n + "parent_id=" + encodeURIComponent(t), this._load_type, function() {
        ...
        iterateScales: function(t, e, n, i, a) {
          for (var s = e.trace_x, r = t.trace_x, o = n || 0, d = i || r.length - 1, _ = 0, l = 1; l < s.length; l++)
            for (var h = o; d >= h; h++) + r[h] != +s[l] || (a && a.apply(this, [_, l, o, h]), o = h, _ = l)
        },
        ...
        _resize: function(t, e, n) {
          ...
          n.left ? (t.start_date = gantt.dateFromPos(a.start + e), t.start_date || (t.start_date = new Date(gantt.getState().min_date))) : (t.end_date = gantt.dateFromPos(a.end + e),
            t.end_date || (t.end_date = new Date(gantt.getState().max_date))), t.end_date - t.start_date < i.min_duration && (n.left ? t.start_date = gantt.calculateEndDate(t.end_date, -1) : t.end_date = gantt.calculateEndDate(t.start_date, 1)), gantt._init_task_timing(t)
        },
        ...
        _move: function(t, e, n) {
          ...
          a ? s ? (t.start_date = a,
            t.end_date = s) : (t.end_date = new Date(gantt.getState().max_date), t.start_date = gantt.dateFromPos(gantt.posFromDate(t.end_date) - (i.end - i.start))) : (t.start_date = new Date(gantt.getState().min_date), t.end_date = gantt.dateFromPos(gantt.posFromDate(t.start_date) + (i.end - i.start)))
        },
          ...
          if (e.mode) {
            ...
            if (this._handlers[e.mode]) {
              var r = dhtmlx.mixin({}, s),
                o = dhtmlx.mixin({}, s);
              this._handlers[e.mode].apply(this, [o, a, e]), dhtmlx.mixin(s, o, !0), gantt._update_parents(e.id, !0), gantt.callEvent("onTaskDrag", [s.id, e.mode, o, r, t]),
                dhtmlx.mixin(s, o, !0), gantt._update_parents(e.id), gantt.refreshTask(e.id)
            }
          }
        },
        ...
        on_mouse_up: function(t) {
          ...
          if (e.mode && e.id) {
            ...
            if (gantt.config.work_time && gantt.config.correct_work_time && this._fix_working_times(n, e), this._fix_dnd_scale_time(n, e), gantt._init_task_timing(n), this._fireEvent("before_finish", e.mode, [e.id, e.mode, dhtmlx.copy(e.obj), t])) {
              var i = e.id;
              gantt._init_task_timing(n), this._fireEvent("after_finish", e.mode, [i, e.mode, t]), this.clear_drag_state(),
        ...
        _get_drag_mode: function(t) {
          ...
          switch (i) {
            ...
            case "gantt_task_drag":
              a.mode = e.resize, n[1] && -1 !== n[1].indexOf("left", n[1].length - "left".length) ? a.left = !0 : a.left = !1;
              break;
        ...
        this._tasks = {
          ...
          var e = this.locate(t),
            i = this.getTask(e),
            a = null;
          return n.parentNode && gantt._getClassName(n.parentNode) && (a = gantt._getClassName(n.parentNode).indexOf("_left") > -1 ? i.$target[0] : i.$source[0]), a && this._delete_link_handler(a, t), !1
        ...
        if (this._is_chart_visible()) {
          ...
          for (var r = this._get_resize_options(), o = r.x ? Math.max(this.config.autosize_min_width, 0) : this.$task.offsetWidth, d = a.prepareConfigs(s, this.config.min_column_width, o, i), _ = this._tasks = d[d.length - 1], l = [], h = this.templates.scale_row_class, g = 0; g < d.length; g++) {
            var c = "gantt_scale_line",
              u = h(d[g]);
            u && (c += " " + u), l.push('<div class="' + c + '" style="height:' + d[g].height + "px;line-height:" + d[g].height + 'px">' + this._prepare_scale_html(d[g]) + "</div>")
          }
          t = l.join(""), e = _.full_width + this.$scroll_ver.offsetWidth + "px", n = _.full_width + "px", i += "px"
        }
        this._is_chart_visible() ? this.$task.style.display = "" : this.$task.style.display = "none", this.$task_scale.style.height = i, this.$task_data.style.width = this.$task_scale.style.width = e, this.$task_scale.innerHTML = t
        ...
        return this.getState().selected_task == t.id && (l += " gantt_selected"),
          i.className = l, i.style.height = gantt.config.row_height + "px", i.setAttribute(this.config.task_attribute, t.id), i
        ...
        if (r.link_source_id == n && i.push("gantt_link_source"), r.link_target_id == n && i.push("gantt_link_target"),
          this.config.highlight_critical_path && this.isCriticalTask && this.isCriticalTask(s) && i.push("gantt_critical_task"), r.link_landing_area && r.link_target_id && r.link_source_id && r.link_target_id != r.link_source_id) {
        ...
        if (!this._isAllowedUnscheduledTask(t)) {
          ...
          (t.color || t.progressColor || t.textColor) && (_ += " gantt_task_inline_color"), s.className = _;
          var l = ["left:" + e.x + "px", "top:" + (a + e.y - 7) + "px", "height:" + i + "px", "line-height:" + i + "px", "width:" + r + "px"];
        ...
        if (i.getContext) {
          ...
          r.className = "gantt_task_row", o.className = "gantt_task_cell", r.style.display = o.style.display = "none", n.appendChild(r), r.appendChild(o);
          var d = i.getContext("2d");
          d.beginPath(), d.moveTo(0, a), d.lineTo(s, a), d.lineWidth = 1, d.strokeStyle = getComputedStyle(r).getPropertyValue("border-bottom-color") || "#ebebeb", d.stroke(), d.beginPath(), d.moveTo(s, a), d.lineTo(s, 0), d.lineWidth = 1, d.strokeStyle = getComputedStyle(o).getPropertyValue("border-right-color") || "#ebebeb", d.stroke(), e.fill_img = i.toDataURL(), n.style.height = a * gantt._order.length + "px",
            n.style.backgroundImage = "url(" + e.fill_img + ")", n.removeChild(r)
        }
        ...
        var i = "json",
          a = null;
        arguments.length >= 3 ? (i = e, a = n) : "string" == typeof arguments[1] ? i = arguments[1] : "function" == typeof arguments[1] && (a = arguments[1]), this._load_type = i,
        ...
        for (var e, n = t.data, i = 0; i < n.length; i++) e = n[i], this._init_task(e), this.callEvent("onTaskLoading", [e]) && (this._order_full.push(e.id), this._pull[e.id] = e);
        for (var i in this._pull) e = this._pull[i], this.setParent(e, this.getParent(e) || this.config.root_id);
        for (var i = 0; i < this._order_full.length; i++) e = this._pull[this._order_full[i]], this._add_branch(e), e.$level = this.calculateTaskLevel(e);
        if (this._sync_order(), this._init_links(t.links || (t.collections ? t.collections.links : [])),
        ...
        parse: function(data) {
          return dhtmlx.assert(data, "Invalid data"), "string" == typeof data && (window.JSON ? data = JSON.parse(data) : (gantt._temp = eval("(" + data + ")"), data = gantt._temp || {}, gantt._temp = null)), data.dhx_security && (dhtmlx.security_key = data.dhx_security),
            data
        },
        ...
        return dhtmlx.assert(t, "Invalid argument for gantt.getTask"), dhtmlx.assert(this._pull[t], "Task not found id=" + t),
          this._pull[t]
        ...
        return dhtmlx.defined(e) || (e = this.getTask(t)), this.callEvent("onBeforeTaskUpdate", [t, e]) === !1 ? !1 : (this._pull[e.id] = e, this._is_parent_sync(e) || this._resync_parent(e), this._isAllowedUnscheduledTask(e) && (this._init_task(e), this._sync_links()), this._update_parents(e.id),
          this.refreshTask(e.id), this.callEvent("onAfterTaskUpdate", [t, e]), this._sync_order(), void this._adjust_scales())
        ...
        a || (1 * e == e ? i.splice(e, 0, t.id) : i.push(t.id)), this._sync_parent(t)
      }, gantt._move_branch = function(t, e, n) {
        this.setParent(t, n), this._sync_parent(t), this._replace_branch_child(e, t.id), this.isTaskExists(n) || n == this.config.root_id ? this._add_branch(t) : delete this._branches[t.id],
          t.$level = this.calculateTaskLevel(t), this._sync_order()
        ...
        /*return dhtmlx.assert(i, "Invalid dates"), new Date(i)*/
        ...
        if (t = t || {}, t.id = dhtmlx.uid(), t.start_date || (t.start_date = gantt._default_task_date(t, e)), void 0 === t.text && (t.text = gantt.locale.labels.new_task), void 0 === t.duration && (t.duration = 1),
          e) {
          this.setParent(t, e);
          var i = this.getTask(e);
          i.$open = !0
        ...
        this._clear_data(), this.callEvent("onClear", []),
          this.refreshData()
        ...
        return dhtmlx.defined(t.id) || (t.id = dhtmlx.uid()), t.start_date && (t.start_date = gantt.date.parseDate(t.start_date, "xml_date")), t.end_date && (t.end_date = gantt.date.parseDate(t.end_date, "xml_date")), t.start_date ? !t.end_date && t.duration && (t.end_date = this.calculateEndDate(t.start_date, t.duration)) : t.end_date && void 0 !== t.duration && (t.start_date = this.calculateEndDate(t.end_date, -t.duration)),
          this._isAllowedUnscheduledTask(t) && this._set_default_task_timing(t), gantt._init_task_timing(t), t.start_date && t.end_date && gantt.correctTaskWorkTime(t), t.$source = [], t.$target = [], void 0 === t.parent && this.setParent(t, this.config.root_id), dhtmlx.defined(t.$open) || (t.$open = dhtmlx.defined(t.open) ? t.open : this.config.open_tree_initially), t.$level = this.calculateTaskLevel(t), t
      ...
      gantt._is_flex_task = function(t) {
        ...
        if (t) {
          for (var n = this.getTask(t), i = this.getParent(n); !n.$no_end && !n.$no_start && i && this.isTaskExists(i);) n = this.getTask(i), i = this.getParent(n);
        ...
        if (o) {
          for (var d = [], _ = o.length - 1; _ >= 0; _--) d[_] = this._pull[o[_]];
          d.sort(s);
          for (var _ = 0; _ < d.length; _++) o[_] = d[_].id, this.sort(t, e, o[_], !0)
        }
        a && this.render()
        ...
        t.setTransactionMode("POST", !0), t.serverProcessor += (-1 != t.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", t._serverProcessor = t.serverProcessor, t.styles = {
          ...
          n.$drop_target && (t.setGanttMode("tasks"),
            this.getTask(e).target = n.$drop_target, t.setUpdated(e, !0, "order"), delete this.getTask(e).$drop_target)
        ...
        t.afterUpdate = function() {
          ...
          if ("tasks" == t._ganttMode && gantt.isTaskExists(e)) {
            ...
            i.$dataprocessor_class = n, gantt.refreshTask(e)
          }
      ...
      }, gantt.skins = {}, gantt._lightbox_methods = {}, gantt._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>",
      gantt.showLightbox = function(t) {
        ...
        if (void 0 === t && (t = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this._get_safe_type(t)) {
          ...
          i += "</div>", e.innerHTML = i, gantt.config.drag_lightbox && (e.firstChild.onmousedown = gantt._ready_to_dnd,
        ...
        gantt.lightbox_events = {}, gantt.lightbox_events.gantt_save_btn = function(t) {
          ...
          if (e.getAttribute("dhx_button")) gantt.callEvent("onLightboxButton", [e.className, e, t]);
            ...
            var n, i, a, s = gantt._getClassName(e); - 1 != s.indexOf("gantt_custom_button") && (-1 != s.indexOf("gantt_custom_button_") ? (n = e.parentNode.getAttribute("index"), a = e.parentNode.parentNode) : (n = e.getAttribute("index"), a = e.parentNode, e = e.firstChild));
            var r = gantt._get_typed_lightbox_config();
            n && (i = gantt.form_blocks[r[n].type], i.button_click(n, e, a, a.nextSibling))
          }
        ...
        var t = this.getLightboxValues();
        this.callEvent("onLightboxSave", [this._lightbox_id, t, !!t.$new]) && (t.$new ? (delete t.$new, this.addTask(t)) : this.isTaskExists(t.id) && (dhtmlx.mixin(this.getTask(t.id), t, !0),
        ...
        dhtmlxEvent(document.body, "mousemove", gantt._move_while_dnd), dhtmlxEvent(document.body, "mouseup", gantt._finish_dnd),
          gantt._init_dnd_events = function() {}
          ...
          for (var o = "", d = 0; d < n.length; d++) {
            ...
            switch (_) {
              case "%Y":
                ...
                var h, g, c, u;
                t.year_range && (isNaN(t.year_range) ? t.year_range.push && (c = t.year_range[0], u = t.year_range[1]) : h = t.year_range), h = h || 10, g = g || Math.floor(h / 2),
                  c = c || a.getFullYear() - g, u = u || c + h;
        ...
        select: {
          ...
          set_value: function(t, e, n, i) {
            ...
            !a._dhx_onchange && i.onchange && (a.onchange = i.onchange,
              a._dhx_onchange = !0), "undefined" == typeof e && (e = (a.options[0] || {}).value), a.value = e || ""
          },
          get_value: function(t, e) {
            return t.firstChild.value
          },
        ...
        duration: {
          ...
          set_value: function(t, e, n, i) {
            ...
            gantt.form_blocks._fill_lightbox_select(o, 0, u, g, r), _.value = p, a()
          },
        ...
        var e = t,
          n = {
            ...
            set_value: function(t, i, a, s) {
              ...
              return n.enable(t, s), e.set_value.call(gantt, t, i, a, s)
            },
        ...
        return n
      }, gantt.form_blocks.duration_optional = gantt._extend_to_optional(gantt.form_blocks.duration), gantt.form_blocks.time_optional = gantt._extend_to_optional(gantt.form_blocks.time), gantt._init_dp_live_update_hooks = function(t) {
        t.attachEvent("insertCallback", gantt._insert_callback), t.attachEvent("updateCallback", gantt._update_callback),
        ...
        "links" == i && (s.add = gantt.addLink, s.isExist = gantt.isLinkExists), s.isExist.call(gantt, e) || (a.id = e, s.add.call(gantt, a))
      }, gantt._delete_callback = function(t, e, n, i) {
        var a = {
          "delete": gantt.deleteTask,
          isExist: gantt.isTaskExists
        };
        "links" == i && (a["delete"] = gantt.deleteLink, a.isExist = gantt.isLinkExists), a.isExist.call(gantt, e) && a["delete"].call(gantt, e)
      }, gantt._get_safe_type = function(t) {
        for (var e in this.config.types)
      ...
      function() {
        ...
        gantt._cached_functions = {
              ...
              if (n) {
                ...
                e._prefetch_originals[t] = n, e[t] = function() {
                  if (i.active) {
                    ...
                    i.cache[t] || (i.cache[t] = {});
                    var a = i.cache[t];
                    if (i.has_cached_value(a, e)) return i.get_cached_value(a, e);
                    var s = n.apply(this, arguments);
                    return i.cache_value(a, e, s), s
                  }
          ...
          }, gantt.attachEvent("onBeforeGanttRender", t), gantt.attachEvent("onBeforeDataRender", t),
          gantt.attachEvent("onBeforeParse", t), gantt.attachEvent("onDataRender", function() {
        ...
        this.callEvent("onBeforeGanttReady", []), e && n && (this.config.start_date = this._min_date = new Date(e),
          this.config.end_date = this._max_date = new Date(n)), this._init_skin(), this.date.init(), this.config.scroll_size || (this.config.scroll_size = this._detectScrollSize()), dhtmlxEvent(window, "resize", this._on_resize), this.init = function(t) {
        ...
        this._init_html_area(t), this._set_sizes(), this._clear_renderers(), this.resetLightbox(), this._update_flags(),
          this._init_touch_events(), this._init_templates(), this._init_grid(), this._init_tasks(), this._set_scroll_events(), dhtmlxEvent(this.$container, "click", this._on_click), dhtmlxEvent(this.$container, "dblclick", this._on_dblclick), dhtmlxEvent(this.$container, "mousemove", this._on_mousemove), dhtmlxEvent(this.$container, "contextmenu", this._on_contextmenu), this.callEvent("onGanttReady", []), this.render()
      }, gantt._init_html_area = function(t) {
        "string" == typeof t ? this._obj = document.getElementById(t) : this._obj = t, window.gantt !== gantt && (this._obj.gantt = gantt),
        ...
        this.$grid = n[0], this.$task = n[1], this.$scroll_ver = n[2], this.$scroll_hor = n[3], this.$grid.innerHTML = "<div class='gantt_grid_scale'></div><div class='gantt_grid_data'></div>",
        ...
        var n = {};
        this._cached_scroll_pos = this._cached_scroll_pos || {}, void 0 !== t && (n.x = Math.max(t, 0)), void 0 !== e && (n.y = Math.max(e, 0)), dhtmlx.mixin(this._cached_scroll_pos, n, !0)
        ...
        if (this._is_render_active()) {
          ...
          var t = dhtmlx.copy(this._restore_scroll_state()),
            e = null;
          if (t && (e = gantt.dateFromPos(t.x + this.config.task_scroll_offset)), this._render_grid(), this._render_tasks_scales(), this._scroll_resize(), this._on_resize(), this._render_data(), this.config.preserve_scroll && t) {
            var n = gantt._restore_scroll_state(),
              i = gantt.dateFromPos(n.x);
      ...
      function() {
        dhtmlx.mixin(gantt.config, {
          ...
          n = n || t, this.config[t] && i[n] != this.config[t] && (e && this.templates[n] || (this.templates[n] = this.date.date_to_str(this.config[t]), i[n] = this.config[t])), this._reg_templates = i
          ...
          var e = this.date.date_to_str,
            n = this.config;
          gantt._init_template("date_scale", !0), gantt._init_template("date_grid", !0, "grid_date_format"), gantt._init_template("task_date", !0),
          ...
          if (n = n || {}, "string" != typeof n) {
            ...
            return this.each(function() {
              if (this && this.getAttribute)
                if (this.gantt) i.push("object" == typeof this.gantt ? this.gantt : window.gantt);
                else {
        ...
        var n = document.createElement("DIV");
        n.id = "gantt_" + dhtmlx.uid(), n.style.width = "100%", n.style.height = "100%", n.cmp = "grid",
          document.body.appendChild(n), this.attachObject(n.id);
        ...
        this._gantt_touch_event_ready || (this._gantt_touch_event_ready = 1,
            ...
            if (!n(t) && o) {
              ...
              if (a && _) {
                var h = _.pageX - a.pageX,
                  g = _.pageY - a.pageY;
                if (!d && (Math.abs(h) > 5 || Math.abs(g) > 5) && (gantt._touch_scroll_active = d = !0, r = 0, s = gantt.getScrollState()), d) {
                  gantt.scrollTo(s.x + h, s.y + g);
                  var c = gantt.getScrollState();
                  if (s.x != c.x && g > 2 * h || s.y != c.y && h > 2 * g) return i(t);
                }
              }
              return i(t)
            }
          ...
          if (!n(t)) {
            ...
            l = setTimeout(function() {
              ...
              !t || gantt._locate_css(_, "gantt_link_control") || gantt._locate_css(_, "gantt_grid_data") || (gantt._tasks_dnd.on_mouse_down(_), gantt._tasks_dnd.drag && gantt._tasks_dnd.drag.start_drag && (a(t),
                gantt._tasks_dnd._start_dnd(_), gantt._touch_drag = !0, gantt.refreshTask(t), gantt._touch_feedback())), l = null
          ...
          if (!n(t)) {
            ...
            var i = e(t);
            gantt._tasks_dnd.on_mouse_up(i), h && (gantt.refreshTask(gantt.locate(h)), h.parentNode && (h.parentNode.removeChild(h), gantt._touch_feedback())), gantt._touch_scroll_active = o = d = !1, h = null
          }
        })
      };
    ...
    var i = document.createElement("DIV");
    return i.id = "dhxSchedObj_" + this._genStr(12), i.style.cssText = "width:100%; height:100%;", document.body.appendChild(i), this.attachObject(i.id, !1, !0), n = n || (window.gantt.$container ? Gantt.getGanttInstance() : window.gantt), this.vs[this.av].sched = n, this.vs[this.av].schedId = i.id,
      n.destructor = function() {}, n.init(i.id, t, e), this.vs[this._viewRestore()].sched
  });
